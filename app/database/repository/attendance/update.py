...
class UpdateAttendanceRepo:
    # ! Если можно объеденить в один метод обновление статуса посещаемости студента, принятие или отклонение причины отсутствия,
    # ! сделать разграничение по роли староста/перпод
    # Метод: PATCH
    # Путь: /attendance
